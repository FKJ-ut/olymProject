    ...
    <div class="py-12">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            @if (Auth::user()->role->name === 'Host' || Auth::user()->role->name === 'Admin')
                <div class="mt-6">
                    <a href="{{ route('create') }}"
                        class="bg-green-500 hover:bg-green-600 text-black font-semibold py-2 px-4 rounded-lg">Create New
                        Section</a>
                </div>
            @endif
            ...
            @if (Auth::user()->role->name === 'Host')
                <div class="mt-6">
                    <a href="{{ route('users.index') }}"
                        class="bg-green-500 hover:bg-green-600 text-black font-semibold py-2 px-4 rounded-lg">Manage
                        Users</a>
                </div>
            @endif
